 ...
 */function run(a){var b=a.less,c=!(void 0!==b)||b,d=a.sass,e=!(void 0!==d)||d,f=a.index,g=void 0===f?"":f,h=a.dist,i=void 0===h?"./dist":h,j=a.port,k=void 0===j?1e3:j,l=a.reactRuntime,m=a.banner,n=void 0===m?"project":m,o=a.rsConfig,p=void 0===o?{}:o;return __awaiter(this,void 0,void 0,function(){var a;return __generator(this,function(b){switch(b.label){case 0:return[4/*yield*/,(0,core_1.createRsbuild)({rsbuildConfig:getBuildConfig({dev:!0,less:c,sass:e,index:g,dist:i,port:k,reactRuntime:l,banner:n,rsConfig:p})})];case 1:return a=b.sent(),a.startDevServer(),[2/*return*/]}})})}exports.run=run;/**
